      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <div className="grayscale opacity-60 transition-all duration-300 hover:grayscale-0 hover:opacity-100">
            <svg className="h-10 w-auto" viewBox="0 0 60 25" fill="currentColor">
              <path d="M59.64 14.28h-8.06c.19 1.93 1.6 2.55 3.2 2.55 1.64 0 2.96-.37 4.05-.95v3.32a10.5 10.5 0 0 1-4.56.95c-4.01 0-6.83-2.5-6.83-7.28 0-4.19 2.39-7.32 6.29-7.32 3.87 0 5.91 2.96 5.91 6.74 0 .72-.05 1.39-.14 1.99h-.86zm-5.77-5.65c-1.31 0-2.25.96-2.41 2.8h4.72c-.09-1.86-.88-2.8-2.31-2.8zM40.95 20.3c-1.44 0-2.32-.6-2.9-1.04l-.02 4.63-4.12.87V5.57h3.76l.08 1.02a4.7 4.7 0 0 1 3.23-1.29c2.9 0 5.62 2.6 5.62 7.18 0 5.06-2.7 7.82-5.65 7.82zm-.79-11.11c-1.17 0-1.93.43-2.33.93v5.78c.37.42 1.1.91 2.25.91 1.77 0 2.91-1.67 2.91-3.9 0-2.31-1.11-3.72-2.83-3.72zM28.24 5.57h4.13v14.44h-4.13V5.57zm0-5.57h4.13v3.65h-4.13V0zM25.64 5.57l-.08 1.37c-.7-.99-1.9-1.65-3.48-1.65-2.81 0-5.43 2.58-5.43 7.08 0 4.91 2.56 7.75 5.39 7.75 1.49 0 2.67-.58 3.45-1.47v1.06c0 2.01-1.12 3.07-3.18 3.07-1.52 0-2.84-.46-4.02-1.2l-1.25 3.06c1.44.91 3.51 1.51 5.57 1.51 4.79 0 6.96-2.49 6.96-6.94V5.57h-3.93zm-.15 9.87c-.38.5-1.14.98-2.21.98-1.69 0-2.74-1.34-2.74-3.68 0-2.21 1.08-3.63 2.79-3.63 1.04 0 1.8.46 2.16.93v5.4zM7.03 12.25c0-1.15.89-1.66 2.14-1.66a7.7 7.7 0 0 1 3.31.8V7.7a9.8 9.8 0 0 0-3.31-.57c-3.45 0-6.25 1.81-6.25 5.15 0 4.92 6.31 4.17 6.31 6.35 0 1.37-1.18 1.83-2.5 1.83-1.44 0-3.26-.62-4.52-1.47v3.76c1.32.67 3.09 1.1 4.52 1.1 3.54 0 6.54-1.58 6.54-5.18 0-5.28-6.24-4.4-6.24-6.42z" />
            </svg>
          </div>
